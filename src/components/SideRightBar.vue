<template>
  <div class="side-right-bar">
    <div class="extend animated" title="展开" v-show="isShow" @mouseover="change()">
      <img src="@/assets/img/siderightbar/sidebar-extend.png" alt />
    </div>
    <div class="side-right-warp animated fadeInRight" v-show="!isShow">
      <div class="shrink" title="收缩" @click="change()">
      ...
      <ul class="side-right-warp-list">
        ...
        >
          <div
            class="main"
            :class="currentActive && currentActive == item.event ? 'active' : ''"
            :title="item.title ? item.title : ''"
            @click="handelClick(item.event)"
          >
          ...
          <ul class="sub-warp" v-if="item.children">
            <li
              ...
              :class="currentActive && currentActive == subItem.event ? 'active' : ''"
              @click="handelClickSub(subItem.event)"
            >
    ...
    return {
      menus: [
        ...
        { title: "视角保存", icon: "icon-guangshijiao", event: "perspective" },
        {
          ...
          event: "",
          children: [
            { title: "自定义", icon: "icon-zidingyishuju", event: "custom1" },
        ...
        },
        {
          ...
          event: "",
          children: [
            { title: "自定义", icon: "icon-zidingyishuju", event: "custom2" },
        ...
        },
        {
          ...
          event: "",
          children: [
            { title: "自定义", icon: "icon-zidingyishuju", event: "custom3" },
